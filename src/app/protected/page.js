...
export default function ProtectedPage() {
    ...
    // To avoid server-rendered HTML inconsistancy with client 
    useEffect(() => {
        setUserName(cookies.get('user-name'));
    }, [])
        ...
        <aside className="fixed inset-y-0 left-0 bg-white shadow-md max-h-screen w-60">
            <div className="flex flex-col justify-between h-full">
                ...
                <div className="p-4 cursor-pointer" onClick={logout}>
                    ...
                    </button> <a className="font-bold text-sm ml-2">Logout</a>
                </div>
            </div>
        </aside>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="col-span-2">
                                        <div className="p-4 bg-green-100 rounded-xl">
                                            <div className="font-bold text-xl text-gray-800 leading-none">Good day, <br />{userName}</div>
                                            <div className="mt-5">
